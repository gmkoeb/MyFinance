    ...
    <header className="bg-neutral-100 py-5 border-b border-neutral-400 px-4 mb-20 font-heading">
      <nav className="flex justify-between">
        ...
        <div className="flex gap-3">
          <NavLink
            className={
              'border p-2 w-32 text-center rounded-lg border-black hover:text-neutral-100 hover:bg-blue-500 duration-300'
            }
            to="/sign_up"
          >
            Criar Conta
          ...
          <NavLink
            className={
              'border p-2 w-32 text-center bg-blue-500 text-neutral-100 rounded-lg'
            }
            to="/sign_in"
          >
            Entrar
