...
ActiveRecord::Schema[7.1].define(version: 20_241_108_183_701) do
  ...
  create_table 'companies', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id name], name: 'index_companies_on_user_id_and_name', unique: true
  ...
  create_table 'monthly_bills', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[company_id name], name: 'index_monthly_bills_on_company_id_and_name', unique: true
